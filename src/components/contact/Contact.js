  ...
  return (
    <div className='background-home contact-page'>
      ...
      <Link to={'https://github.com/AlbertGPe'} target='_blank'>
        <img src={github} alt="github" className='m-1 px-2'/>
      </Link>
      <Link to={'https://www.linkedin.com/in/albert-garcia-pedrosa/'} target='_blank'>
        <img src={linkedin} alt="linkedin" className='m-1 px-2'/>
      </Link>
      </div>
      <p className='mt-5 mb-4'><b>Email: </b><Link to={'mailto: albertgarciapedrosa@gmail.com'}>albertgarciapedrosa@gmail.com</Link></p>
